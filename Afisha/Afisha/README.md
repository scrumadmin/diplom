...
To update the database use this command from the Web project folder (replace `Afisha` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Afisha.Infrastructure/Afisha.Infrastructure.csproj -s Afisha.Web.csproj
```
